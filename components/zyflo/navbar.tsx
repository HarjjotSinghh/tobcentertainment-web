 ...
 * };
 */
export interface ZyfloNavbarItem {
  title: string
  href: string
  label?: string
...
export interface ZyfloNavbarLogoImageComponent
 ...
 * };
 */
export interface ZyfloNavbarLogoTextComponent
 ...
 */
export type ZyfloNavbarLogoComponent =
 ...
 * };
 */
export interface ZyfloNavbarProps
 ...
 * };
 */
export interface ZyfloMobileNavbarFooterProps
  ...
  return (
    <header
      className={cn(
        ...
        } z-50 flex items-center justify-${justify} border-b border-b-foreground/10 bg-background/90 px-4 py-5 backdrop-blur lg:px-8`,
        className
      )}
      {...props}
    >
